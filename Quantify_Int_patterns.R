...
wild_parallel_graph_data = bind_rows(Wild_mean_parallel, 
  ...
  mutate(Var1.x_new = case_when(
    ...
    Var1.x == 'fbar_23_27' ~ 'Shared 4bar linkage 23-27', 
    Var1.x == 'fbar_25_26' ~ 'Supraoccipital crest 25-26', 
  ...
  mutate(Var2.x_new = case_when(
    ...
    Var2.x == 'fbar_23_27' ~ 'Shared 4bar linkage 23-27', 
    Var2.x == 'fbar_25_26' ~ 'Supraoccipital crest 25-26', 
...
wild_parallel_graph_data$Var1.x_new = factor(wild_parallel_graph_data$Var1.x_new, 
                                         levels=c("LM 1-2", 
                                                  ...
                                                  'Opercular 4bar 8-24', 
                                                  'Opercular 4bar 8-27', 
                                                  'Shared 4bar linkage 23-27', 
                                                  'Supraoccipital crest 25-26', 
                                                  'Maxilla 4bar 3-27', 
                                                  'Maxilla 4bar 3-28', 
                                                  'Maxilla 4bar 28-23', 
                                                  'LM 1-16', 
...
Super_parallel_graph_data$Var1.x_new = factor(Super_parallel_graph_data$Var1.x_new, 
                                             levels=c("LM 1-2", 
                                                      "LM 22-6", 
                                                      "OMA", 
                                                      "CMA", 
                                                      ...
                                                      'LM 14-18', 
                                                      'LM 15-17'))  
Super_parallel_graph_data$Var2.x_new = factor(Super_parallel_graph_data$Var2.x_new, 
                                             levels=c("LM 1-2", 
                                                      "LM 22-6", 
                                                      "OMA", 
                                                      "CMA", 
