...
PC_strong_loadings = pca$rotation %>%
  ...
  dplyr::select(traits,
                PC1:PC7)%>%
  pivot_longer(cols = c(PC1, PC2, PC3, PC4, PC5, PC6, PC7),
               names_to = "PC",
               values_to = "loading")
...
combo_of_combo_plots = wild_combo_plot/F2_orig_combo/WGP_combo_plot/TGP_combo_plot

ggsave('Multivariate_integration_PCA.svg', 
